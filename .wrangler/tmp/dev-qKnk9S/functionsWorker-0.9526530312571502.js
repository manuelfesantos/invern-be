// .wrangler/tmp/bundle-8dhhpz/checked-fetch.js
...
// .wrangler/tmp/pages-3BmDHY/functionsWorker-0.9526530312571502.mjs
...
var onRequest2 = async (context) => {
  ...
  await db
    .prepare(`INSERT INTO users (id, full_name) VALUES ('123', 'John Doe')`)
    .run();
...
var onRequest3 = async (context) => {
  ...
  try {
    ...
    await db
      ...
      .bind(crypto.randomUUID(), body.username, encryptedPassword)
      .run();
...
// .wrangler/tmp/bundle-8dhhpz/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-8dhhpz/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.9526530312571502.js.map
