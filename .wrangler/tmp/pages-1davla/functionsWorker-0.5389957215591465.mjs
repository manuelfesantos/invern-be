// ../.wrangler/tmp/bundle-hAnWyK/checked-fetch.js
...
var onRequest3 = async (context) => {
  ...
  try {
    ...
    const db = context.env.INVERN_DB;
    console.log("db", db);
    await db.prepare("INSERT INTO user (username, password) VALUES (?, ?)").bind(body.username, encryptedPassword).run();
...
// ../.wrangler/tmp/pages-1davla/functionsRoutes-0.5260000957510043.mjs
var routes = [
  {
    routePath: "/hasher",
    mountPath: "/",
...
// ../.wrangler/tmp/bundle-hAnWyK/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-hAnWyK/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.5389957215591465.mjs.map
