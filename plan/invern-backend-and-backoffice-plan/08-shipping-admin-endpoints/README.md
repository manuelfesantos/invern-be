...
> **Progress (SPIRIT-108):** step-01 (shipping method admin CRUD at `/private/shipping/methods`) **Done** — verified live. Remaining: step-02 (rate admin), step-03 (rate↔country assignment), step-04 (swagger + tests).
