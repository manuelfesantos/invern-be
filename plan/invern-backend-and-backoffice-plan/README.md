...
| 05 | [Configuration & Data Hygiene](./05-configuration-data-hygiene/README.md) | Backend Hardening | P0 | In Progress | Rewrite the drifted `.env.example`, remove dead Turso/`COUNTRIES_BUCKET` config, rename the mislabeled "sendgrid" (→ Brevo) adapter, and remediate `npm audit` findings. (steps 01/03/04 done; 02 Brevo-rename + 05 wrangler/README pending) |
