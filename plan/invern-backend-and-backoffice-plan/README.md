...
| 08 | [Shipping Admin Endpoints](./08-shipping-admin-endpoints/README.md) | Backend API Completion | P0 | In Progress | Wire the already-existing shipping DB layer into admin use-cases and new `/private/shipping/*` routes for methods, rates and rate-to-country assignment. (step-01 methods CRUD done) |
